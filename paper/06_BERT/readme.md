...
스케쥴러를 이것저것 사용으나 ELMo 논문에서 제시했던 스케쥴러가 valid accuracy가 가장 높았음
...
- bert + lstm + crf : bert output을 lstm을 한번 더 통과한 뒤 fcn + crf. 일부 bio tag가 일관적으로 나오지 못하는 부분 때문에 시도해봄
- fixed bert + lstm + crf : bert 파라미터는 고정시키고 LSTM을 통과함 

## 🤔 Paper review
**1) PPT 한 장 분량으로 자유롭게 논문 정리 뒤 이미지로 첨부**
![image](https://user-images.githubusercontent.com/46675408/127137286-0f2ca0f4-c73b-4a55-98b2-5bdbb77e2cc2.png)
